...
class ModelTest extends TestCase
{
    ...
    {
        $user = new User;
        $this->assertInstanceOf('Hifny\Couchbase\Eloquent\Model', $user);
        $this->assertInstanceOf('Hifny\Couchbase\Connection', $user->getConnection());
    ...
    public function testFind()
    {
        ...
        $this->assertInstanceOf('Hifny\Couchbase\Eloquent\Model', $check);
        $this->assertEquals(true, $check->exists);
    ...
    public function testGet()
    {
        ...
        $this->assertInstanceOf('Hifny\Couchbase\Eloquent\Model', $users[0]);
    }
