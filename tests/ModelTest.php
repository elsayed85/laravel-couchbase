...
class ModelTest extends TestCase
{
    ...
    {
        $user = new User;
        $this->assertInstanceOf('Elsayed85\Couchbase\Eloquent\Model', $user);
        $this->assertInstanceOf('Elsayed85\Couchbase\Connection', $user->getConnection());
    ...
    public function testFind()
    {
        ...
        $this->assertInstanceOf('Elsayed85\Couchbase\Eloquent\Model', $check);
        $this->assertEquals(true, $check->exists);
    ...
    public function testGet()
    {
        ...
        $this->assertInstanceOf('Elsayed85\Couchbase\Eloquent\Model', $users[0]);
    }
